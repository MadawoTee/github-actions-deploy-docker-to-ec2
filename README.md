...
## Made with AssessmentOps
[AssessmentOps](https://assessmentops.sh) allows you to define Infrastructure-as-Code for multiple tools in a central place.  This action uses a AssessmentOps [Operations Repository](https://assessmentops.sh/operations-repo-structure/) to set up the necessary Terraform and Ansible to create infrastructure and deploy to it.
