...
echo "AssessmentOps Ansible before script: Merge Terraform Enviornment Variables..."

# Merging order
order=tf,postgres,repo,ghv,ghs,aws

# Ansible dotenv file -> The final destination of all
DOTENV_FILE="${ASSESSMENTOPS_ENVROOT}/ansible/app.env"

# TF dotenv file
TF_DOTENV_FILE="${ASSESSMENTOPS_ENVROOT}/terraform/tf.env"

# TF dotenv file
POSTGRES_DOTENV_FILE="${ASSESSMENTOPS_ENVROOT}/terraform/postgres.env"

# Repo env file
REPO_ENV_FILE="${ASSESSMENTOPS_ENVROOT}/ansible/repo.env"

# GH Variables env file
GHV_ENV_FILE="${ASSESSMENTOPS_ENVROOT}/ansible/ghv.env"

# GH Secrets  env file
GHS_ENV_FILE="${ASSESSMENTOPS_ENVROOT}/ansible/ghs.env"

# TF AWS dotenv file
AWS_SECRET_FILE="${ASSESSMENTOPS_ENVROOT}/terraform/aws.env"
